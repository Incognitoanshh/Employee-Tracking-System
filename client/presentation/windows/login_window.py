...
class LoginWindow(BaseWindow):
    ...
    def setup_ui(self):
        ...
        subtitle.setStyleSheet("color: #475569; font-size: 12px; background: transparent;")
        ...
        user_label.setStyleSheet("color: #94a3b8; font-size: 12px; font-weight: 600; background: transparent;")
        ...
        pass_label.setStyleSheet("color: #94a3b8; font-size: 12px; font-weight: 600; background: transparent;")
        ...
        version_label.setStyleSheet("color: #334155; font-size: 11px; background: transparent;")
    ...
    def handle_login(self):
        ...
        if result["success"]:
            ...
            self.status_label.setStyleSheet("color: #ef4444; font-size: 13px; background: transparent;")
